...
io.savemat(os.path.join(BASE_DIR, "group/ica_roi_parcel150_refined.mat"), {"template": template_refined})
nii = nib.Nifti1Image(template_refined, brain_img.affine)
nib.save(nii, os.path.join(BASE_DIR, "group/ica_roi_parcel150_refined.nii"))            
