% An example of multi-subject & session SPM8 batch script for preprocessing
%
...
%% Experiment folder
data_path = '/volatile/bernardng/data/sepideh/preprocessedBN/';

%% Subjects folders
% subjects = {'MP070143' 'MZ080021' 'MB080023' 'SV080025' 'CB080029' 'CG080027' 'MP080022'};
subjects = {'BD070142' 'TB070020' 'TG070151'};
...
%% Set Matlab path
%--------------------------------------------------------------------------
addpath(genpath('/volatile/bernardng/matlabToolboxes/spm8'));   % SPM path including editfilename.m
...
parfor i=1:numel(subjects)
    ...
    try
        ...
        expand_nii_scan([fmriPath,'bold_audiospont_1.hdr'],1:nVols-1,[]);
    end
