...
python $script_path/gen_tc_parcel.py -tc restfMRI/tc_vox.mat -gm anat/gmMask.nii -wm anat/wmMask.nii -csf anat/csfMask.nii -t /media/GoFlex/research/data/imagen/group/ica_roi_parcel500_refined.nii
