...
python $script_path/genAveVol.py -i rest.nii
python $script_path/genAveVol.py -i dwi_ecc.nii
...
python $script_path/resample.py -i fs_parcel500.nii -r dwi_ecc_ave_ss.nii
...
mv wmMas*.nii alignment
mv alignment/wmMask_rs_aff.nii .
