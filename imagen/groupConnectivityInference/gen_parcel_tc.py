...
template = io.loadmat(os.path.join(BASE_DIR, "group/fs_parcel500refined.mat"))
...
#        tc = io.loadmat(os.path.join(BASE_DIR, sub, "gcafMRI/tc_task_vox.mat"))
    ...
    if data_type:
        io.savemat(os.path.join(BASE_DIR, sub, "restfMRI", "tc_rest_fs_parcel500.mat"), {"tc_parcel": tc_parcel})
    else:
#        io.savemat(os.path.join(BASE_DIR, sub, "gcafMRI", "tc_task_fs_parcel500.mat"), {"tc_parcel": tc_parcel})
        io.savemat(os.path.join(BASE_DIR, sub, "facesfMRI", "tc_task_fs_parcel500.mat"), {"tc_parcel": tc_parcel})