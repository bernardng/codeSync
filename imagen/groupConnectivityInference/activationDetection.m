...
addpath(genpath('I:/research/toolboxes/nifti/'));
addpath(genpath('I:/research/code/covarianceEstimationBN/'));
addpath(genpath('I:/research/code/bayesianRegressionBN/'));
addpath(genpath('I:/research/code/fMRIanalysis'));
...
% load([filepath,'group/groupFiber/group_all/results_trackvis/K_gaussian_blur_ica_roi_parcel500_refined.mat']);
...
% K = sprandsym(nROIs,0.05,0.9)+2*eye(nROIs);
...
%         load([filepath,sublist{sub},'/dwi/results_ukf/K_gaussian_blur_ica_roi_parcel500_refined.mat']);
